...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            id (int): New Rectangle identity.
        Raises:
            TypeError: In case either of width/height != int.
            ValueError: If width or height <= 0.
            TypeError: If of x or y != int.
    ...
    def to_dictionary(self):
        """Return Rectangle dict representation."""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
