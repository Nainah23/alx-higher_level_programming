...
class TestRectangle_stdout(unittest.TestCase):
    """Creating unit tests to assess the functionality of the `__str__` and display methods within the Rectangle class.     """
    @staticmethod
    def capture_stdout(rect, method):
        """The task involves capturing and retrieving text that is printed to the standard output (stdout).
        Args:
            rect (Rectangle): Rectangle to be printed to stdout.
            method (str): Rect method to run.
        Returns:
            The output displayed on the standard output (stdout) when invoking the method on the variable sq.
        """
        capture = io.StringIO()
        sys.stdout = capture
        if method == "print":
...
class TestRectangle_update_args(unittest.TestCase):
    """Analyzing the update arguments functionality of the Rectangle class via unit tests."""
    # Test args
...
class TestRectangle_update_kwargs(unittest.TestCase):
    """Designing unit tests to evaluate the effectiveness of the `update_kwargs` method in the Rectangle class."""
...
class TestRectangle_to_dictionary(unittest.TestCase):
    """Designing unit tests to assess the performance of the `to_dictionary` method within the Rectangle class."""
